...
<div class="hero">
			...
			<h2 align='center'> Cadastrar Veículos </h2>
                ...
                <form id="avulsos" class="input-group" method="post" action="estacionar-salvar2.php">
                ...
                <form id="mensalista" class="input-group" method="post" action="estacionar-salvar2.php">
