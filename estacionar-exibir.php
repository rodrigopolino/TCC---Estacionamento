...
<div id="container" align="center">
	<!--<a href="estacionar-form.php">--><button class="novo"><a href="estacionar-form.php">Novo</a></button><!--</a>-->
	<br>
	<section>	
		<?php
						...
						while($row = $stmt ->fetch(PDO::FETCH_BOTH)){
							echo "<tr>";				
    							...
    							$row5 = $stmt5->fetch(PDO::FETCH_BOTH);
   								...
   								if($row2[0] == 1){
        							echo "<td><a href='estacionar-excluir.php?id=$row[0]'><img src='deletar.svg'></a></td>";
    							} 
								elseif($row5[0] == 1) {
									echo "<td><a href='estacionar-excluir.php?id=$row[0]'><img src='deletar.svg'></a></td>";
								}
									...
									if($row[8] == "avulso" && $row[7] == "Em aberto") {
										echo "<a href='estacionar-finalizar.php?id=$row[0]'> <img src='finalizar.svg'> </a>";
										
										echo "<td>";
											echo "<a href='estacionar-form?id=$row[0]&placa=$row[1]&marca=$row[2]&modelo=$row[3]&dono=$row[4]' id='alterar''>";
												echo "<img src='editar.svg'>";
											echo "</a>";
										echo "</td>";
									}
									if($row[8] =="Mensalista") {
										echo "<a href='estacionar-finalizar-mensalistas.php?id=$row[0]'><img src='finalizar.svg'> </a>";
									}
								}
								echo "</td>";
